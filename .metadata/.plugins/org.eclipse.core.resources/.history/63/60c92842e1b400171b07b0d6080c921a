...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.httpBasic().and().authorizeRequests().antMatchers("/login", "/register", "/getusermodel").permitAll()
				...
				.antMatchers("/cellulare/getmodel", "/cellulare/getall", "/cellulare/addcellulare/**")
				.hasAnyRole("USER", "ADMIN", "DBA").antMatchers("/cellulare/saveupdate", "/cellulare/delete/**").hasAnyRole("ADMIN", "DBA")
